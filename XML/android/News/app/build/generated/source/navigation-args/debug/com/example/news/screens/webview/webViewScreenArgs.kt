...
public data class webViewScreenArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): webViewScreenArgs {
      bundle.setClassLoader(webViewScreenArgs::class.java.classLoader)
      val __url : String?
      ...
      return webViewScreenArgs(__url)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): webViewScreenArgs {
      val __url : String?
