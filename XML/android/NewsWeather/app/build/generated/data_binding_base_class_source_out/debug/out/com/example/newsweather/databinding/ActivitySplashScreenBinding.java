...
public abstract class ActivitySplashScreenBinding extends ViewDataBinding {
  @NonNull
  public final LottieAnimationView animationViewSplash;

  @NonNull
  public final ConstraintLayout main;

  protected ActivitySplashScreenBinding(Object _bindingComponent, View _root, int _localFieldCount,
      LottieAnimationView animationViewSplash, ConstraintLayout main) {
    super(_bindingComponent, _root, _localFieldCount);
    this.animationViewSplash = animationViewSplash;
    this.main = main;
  }
